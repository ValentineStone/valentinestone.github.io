...
pages without having to write it on each manualy.
...
it could be impoved by making it modular.
...
book and flip through it's pages, or when you go on a website and hover over the
...
social media website, it has it's internal state, it is "living" by itself, and
...
get to create some world, set it's internal laws, bring it to life and allow
...
layed the foundation for my personal project for years to come.
...
Windows going at it. That. Was. Painfull.
...
## My last propper programming book
...
Fullscreen version avaliable [here](/game.html)
